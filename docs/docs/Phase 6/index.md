...
4. **[Automated Email Summary](mix-ai-email.md)** - AI-powered session analysis and automated email reports
5. **[AppLocker Configuration](applocker.md)** - Restrict applications for KioskUser using Windows AppLocker

---

**Let's get started with [DCV Performance Settings →](dcv-performance.md)**
